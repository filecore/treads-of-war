...
import { CONFIG, DIFFICULTY } from './config.js?v=64';
import { TANK_COSTS, FACTION_ROSTERS } from './modes.js?v=64';
...
export function lanEndScreenHtml(st) {
  ...
  if (st.lanNet && st.lanNet.isHost()) {
    ...
    html += `<button id="lan-rematch-btn" class="lan-btn lan-btn-highlight" style="flex:1">Play Again</button>`;
    html += '</div>';
  }
